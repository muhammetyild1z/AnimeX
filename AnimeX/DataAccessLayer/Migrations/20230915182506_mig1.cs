        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SezonCreateDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    AnimeID_SezonAnimeID = table.Column<int>(type: "int", nullable: false),
                    AnimeID = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_animeSezons", x => x.ID);
                    table.ForeignKey(
                        name: "FK_animeSezons_Animelers_AnimeID_SezonAnimeID",
                        column: x => x.AnimeID_SezonAnimeID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_animeSezons_AnimeID_SezonAnimeID",
                table: "animeSezons",
                column: "AnimeID_SezonAnimeID");
