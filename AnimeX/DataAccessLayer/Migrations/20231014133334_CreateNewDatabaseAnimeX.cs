...
{
    public partial class CreateNewDatabaseAnimeX : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AnimeSezonlarAnimelerSezonId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.AnimeSezonlarAnimelerSezonId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AnimeBolums", x => x.BolumID);
                    table.ForeignKey(
                        name: "FK_AnimeBolums_Animelers_animelerAnimeID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    animelerAnimeID = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AnimeBolums_animelerAnimeID",
                table: "AnimeBolums",
