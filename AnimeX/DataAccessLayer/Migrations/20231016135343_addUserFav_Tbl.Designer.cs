...
namespace AnimeX.DataAccessLayer.Migrations
{
    ...
    [Migration("20231016135343_addUserFav_Tbl")]
    partial class addUserFav_Tbl
    {
            ...
            modelBuilder.Entity("EntityLayer.Animeler", b =>
                {
                    ...
                    b.HasOne("EntityLayer.UserFavori", null)
                        .WithMany("animelers")
                        .HasForeignKey("UserFavoriID");
                });
