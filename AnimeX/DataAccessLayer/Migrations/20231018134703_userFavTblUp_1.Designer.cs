...
namespace AnimeX.DataAccessLayer.Migrations
{
    ...
    [Migration("20231018134703_userFavTblUp_1")]
    partial class userFavTblUp_1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EntityLayer.UserFavori", b =>
                {
                    ...
                    b.Property<int>("animeAnimeIDAnimeID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("animeAnimeIDAnimeID");
            ...
            modelBuilder.Entity("EntityLayer.UserFavori", b =>
                {
                    b.HasOne("EntityLayer.Animeler", "animeAnimeID")
                        .WithMany("userFavori")
                        .HasForeignKey("animeAnimeIDAnimeID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EntityLayer.AppUser", "userId")
                        .WithMany("userFavori")
                        .HasForeignKey("userIdId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("animeAnimeID");
